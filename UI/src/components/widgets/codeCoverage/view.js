...
(function () {
    ...
    angular
        ...
        .controller('CodeCoverageWidgetViewController', CodeCoverageWidgetViewController);

    CodeCoverageWidgetViewController.$inject = ['$scope', 'buildData', 'DISPLAY_STATE', '$q', '$modal'];
    function CodeCoverageWidgetViewController($scope, buildData, DISPLAY_STATE, $q, $modal) {
        var ctrl = this;
        var builds = [];
