...
(function () {
    ...
    GraphWidgetConfigController.$inject = ['modalData', '$scope', 'collectorData', '$modalInstance'];
    function GraphWidgetConfigController(modalData, $scope, collectorData, $modalInstance) {
        var ctrl = this;
    ...
    function BuildWidgetConfigController(modalData, $scope, collectorData, $modalInstance) {
        ...
        function submitForm(valid) {
            ...
            if (valid) {
                ...
                var postObj = {
                    name: 'build',
                    //name: 'build' throws duplicate confict as i am unable to add name 
                    componentId: modalData.dashboard.application.components[0].id,
                    collectorItemId: form.collectorItemId.value,
                    // adding the new job url to differentiate the collectorItemId
                    collectorItemIds: form.collectorItemId1.value
                };
